...
def health():
    ...
    is_healthy = all(check == "pass" or check == "skipped" for check in health_checks.values())
...
def init_app():
    """Initialize the application"""
    logger.info(f"Starting ${{values.app_name}} version {app_version} in {environment} environment")
